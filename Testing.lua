...
local MainWindow = library:CreateWindow("iCalux Hub (Private)");
...
MainWindow:Button("Made by icalux#6339",function()

end);

MainWindow:Button("Rejoin Game", function()
...
MainWindow:Button("Join Discord", joindiscord)
