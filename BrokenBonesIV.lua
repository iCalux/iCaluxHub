...
MainWindow:Button("Add 10K",function()
GiveMoney(10000)
end)

MainWindow:Button("Add 100K", function()
GiveMoney(100000)
end)
MainWindow:Button("Add 1M", function()
GiveMoney(1000000)
end)
MainWindow:Button("Add 10M", function()
GiveMoney(10000000)
end)
MainWindow:Button("Add 100M", function()
GiveMoney(100000000)
end)
MainWindow:Button("Add 1B", function()
GiveMoney(1000000000)
end)
MainWindow:Button("Add 10B", function()
GiveMoney(10000000000)
end)
MainWindow:Button("Add 100B", function()
GiveMoney(100000000000)
end)
